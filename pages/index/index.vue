<template>
	<view class="container">
		<block v-for="(item, index) in arr" :key="index">
			...
			<view class="bgwh">
				<uCharts2 :scroll="item.opts.enableScroll" :show="canvas" :canvasId="item.id" :chartType="item.chartType" :extraType="item.extraType" :cWidth="cWidth" :cHeight="cHeight" :opts="item.opts" :ref="item.id"/>
			</view>
		</block>
	</view>
</template>
...
<script>
	import uCharts2 from '@/components/u-charts/u-charts.vue';
